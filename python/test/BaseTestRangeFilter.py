...
class BaseTestRangeFilter(BaseLuceneTestCase):
    ...
    def setUp(self):
        ...
        self.signedIndex = BaseTestRangeFilter.TestIndex(self.MAX_INT, ~self.MAX_INT, True)
        self.unsignedIndex = BaseTestRangeFilter.TestIndex(self.MAX_INT, 0, False)
        self.build(self.signedIndex)
        self.build(self.unsignedIndex)
    
    def tearDown(self):
        self.signedIndex = None
        self.unsignedIndex = None
        self.dir = None
    #
