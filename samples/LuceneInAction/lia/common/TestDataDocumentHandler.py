...
from lucene import \
    ...
    Version, SimpleFSDirectory, DateTools, DateField

# date culled from LuceneInAction.zip archive from Manning site
samplesModified = datetime.date(2004,12,02)
...
class TestDataDocumentHandler(object):
    ...
    def indexFile(cls, writer, path, baseDir):
        ...
        d = DateField.stringToDate(pubmonth)
        d = int(time.mktime(d.timetuple()) / (1000 * 3600 * 24.0))
