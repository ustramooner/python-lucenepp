...
class QueryParserTestCase(BaseLuceneTestCase):

    def testOverrideBooleanQuery(self):

        class TestQueryParser(BooleanTestMixin, QueryParser):
...
class MultiFieldQueryParserTestCase(BaseLuceneTestCase):

    def testOverrideBooleanQuery(self):

        class TestQueryParser(BooleanTestMixin, MultiFieldQueryParser):
            def getFieldQuery_quoted(_self, field, queryText, quoted):
                return super(TestQueryParser, _self).getFieldQuery_quoted_super(field, queryText, quoted)
